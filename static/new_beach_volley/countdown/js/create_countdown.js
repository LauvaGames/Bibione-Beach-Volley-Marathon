    ...
    this.MegaTimer = function() {
        ...
        g.prototype.run = function() {
            ...
            if (null != this.id && (b = this.id, 0 > B.call(z, b)) && (z.push(this.id), this.initView(), this.initType(), null != this.id)) {
                ...
                l = 0;
                for (h = d.length; l < h; l++) c = d[l], e = document.createElement("span"), e.id = "timer-number-" + this.id + "-" + c, a = document.createElement("span"), a.id = "timer-number-value-" + this.id + "-" + c, e.appendChild(a), f = document.createElement("span"), f.id = "timer-text-" + this.id + "-" + c, f.innerHTML = this.timerElements[c].text, test = document.createElement("div"), test.className = "wrap", a = document.createElement("span"), a.className = "timer-element", a.id =
                    "timer-element-" + this.id + "-" + c, test.appendChild(a), a.appendChild(e), a.appendChild(f), b ? b = !1 : (e = document.createElement("span"), e.className = "timer-separator", e.id = "timer-separator-" + this.id + "-" + c, this.container.appendChild(e)), this.container.appendChild(test);
                this.initDesign();
                this.newTime(!0);
