...
<div class="container">
    ...
    <div class="fs-form-wrap" id="fs-form-wrap">
        <div class="fs-title">
            <button style="border: 1px solid white;" class="back"><i class="fa fa-arrow-left" aria-hidden="true"></i><a style='color:white; padding-left:3px' href="<?php echo(base_url());?>">На главную</a></button>
            <h1>Стоимость пакета услуг: <span id="price"></span> евро</h1>
        ...
        <form id="myform" class="fs-form fs-form-full" autocomplete="off">
            <ol class="fs-fields">
                <li data-input-trigger class="li_style">
                    <div>
                        <label class="fs-field-label fs-anim-upper" for="q1">Место проживания</label>
                    ...
                    <div style="margin-top: 50px">
                        <label class="fs-field-label fs-anim-upper" for="q2">Тип проживания</label>
                        <select class="cs-select cs-skin-slide fs-anim-lower" id="q2" name="q2" >
                            <option value="2" data-class="icon-money">Двухместный номер</option>
                            <option value="3" data-class="icon-money">Трёхместный номер</option>
                            <option value="4" data-class="icon-money">Четырёхместный номер</option>
                        </select>
                    </div>
                </li>
                <li data-input-trigger class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q3">Спорт-пакет</label>
                    <select class="cs-select cs-skin-slide fs-anim-lower" id="q3" name="q3">
                        <option value="none" data-class="icon-withoutTrains">Без тренировок и без турнира</option>
                        <option value="tournament" data-class="icon-cup">Участие в турнире</option>
                        <option value="standart" data-class="icon-cup">Стандартный (2 тренировки в день) + турнир</option>
                    </select>
                </li>
                <li data-input-trigger class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q4">Ваш уровень игры</label>
                    <select class="cs-select cs-skin-slide fs-anim-lower" id="q4" name="q4">
                        <option value="sightseeing" data-class="icon-skill1">Новичок </option>
                        <option value="business" data-class="icon-skill2">Любитель</option>
                        <option value="honeymoon" data-class="icon-skill3">Продвинутый</option>
                        <option value="food" data-class="icon-skill4">Полупрофи</option>
                    </select>
                </li>
                <li data-input-trigger class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q5">Дети</label>
                    <select class="cs-select cs-skin-slide fs-anim-lower" id="q5" name="q5">
                        <option value="sightseeing" data-class="icon-circleB">Нет </option>
                        <option value="business" data-class="icon-circleB">Один ребёнок</option>
                        <option value="honeymoon" data-class="icon-circleB">Два ребёнка</option>
                        <option value="food" data-class="icon-circleB">Больше двух</option>
                    </select>
                </li>
                <li data-input-trigger class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q6">Экскурсия в Венецию с русскоговорящим гидом</label>
                    <select class="cs-select cs-skin-slide fs-anim-lower" id="q6" name="q6">
                        <option value="false" data-class="icon-circleW">Нет, спасибо</option>
                        <option value="true" data-class="icon-circleB">Добавить</option>
                    </select>
                </li>
                <li data-input-trigger class="li_style">
                    <div>
                        <label class="fs-field-label fs-anim-upper" for="q7">Индивидуальные тренировки </label>
                    ...
                    <div style="margin-top: 50px">
                        <label class="fs-field-label fs-anim-upper" for="q8">Участие в 3-х номинациях Beach Volley Marathon</label>
                ...
                <li class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q9">Ваше имя</label>
                    <input class="fs-anim-lower" id="q9" name="q9" type="text" placeholder="Dean Moriarty"/>
                </li>
                <li class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q10" data-info="We won't send you spam, we promise...">Введите свой e-mail</label>
                    <input class="fs-anim-lower" id="q10" name="q10" type="email" placeholder="dean@road.us"/>
                </li>
                <li class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q11">Ваш номер телефона</label>
            ...
            <button id="but" class="fs-submit" type="button">Оставить заявку</a></button>
        </form><!-- /fs-form -->
