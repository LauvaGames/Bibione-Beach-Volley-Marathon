...
<head>
    ...
    <style type="text/css">
        ...
        .fs-form-overview .fs-fields::before {
            content: 'Le prix total du package:';
        }
...
<div class="container">
    ...
    <div class="fs-form-wrap" id="fs-form-wrap">
        <div class="fs-title">
            <button style="border: 1px solid white;" class="back"><i class="fa fa-arrow-left" aria-hidden="true"></i><a style='color:white; padding-left:3px' href="http://volley4fun.com/v0v4ik/index.php/main/newvolley_fr">Principal</a></button>
            <h1>Le prix total du package: <span id="price"></span> <i class="fa fa-eur" aria-hidden="true"></i></h1>
        </div>
        <form id="myform" class="fs-form fs-form-full" autocomplete="off">
            <ol class="fs-fields">
                <li data-input-trigger class="li_style">
                    <div>
                        <label class="fs-field-label fs-anim-upper" for="q1">Choissisez la residence</label>
                    ...
                    <div style="margin-top: 50px">
                        <label class="fs-field-label fs-anim-upper" for="q2">Types d'accomondation</label>
                        <select class="cs-select cs-skin-slide fs-anim-lower" id="q2" name="q2" >
                            <option value="2" data-class="icon-money">Appartement partagé en deux pers</option>
                            <option value="3" data-class="icon-money">Appartement partagé en trois pers</option>
                            <option value="4" data-class="icon-money">Appartement partagé en quatre pers</option>
                        </select>
                    </div>
                </li>
                <li data-input-trigger class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q3">Le package sportif</label>
                    <select class="cs-select cs-skin-slide fs-anim-lower" id="q3" name="q3">
                        <option value="none" data-class="icon-withoutTrains">Sans les entraînements et sans tournoi</option>
                        <option value="tournament" data-class="icon-cup">Participation au tournoi</option>
                        <option value="standart" data-class="icon-cup">Participation au tournoi dans 2 catégories + les entraînements</option>
                    </select>
                </li>
                <li data-input-trigger class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q4">Votre niveau de jeu</label>
                    <select class="cs-select cs-skin-slide fs-anim-lower" id="q4" name="q4">
                        <option value="sightseeing" data-class="icon-skill1">Débutant </option>
                        <option value="business" data-class="icon-skill2">Amateur</option>
                        <option value="honeymoon" data-class="icon-skill3">Avancé</option>
                        <option value="food" data-class="icon-skill4">Pro</option>
                    </select>
                </li>
                <li data-input-trigger class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q5">Les enfrants</label>
                    <select class="cs-select cs-skin-slide fs-anim-lower" id="q5" name="q5">
                        <option value="sightseeing" data-class="icon-circleB">Non </option>
                        <option value="business" data-class="icon-circleB">Oui</option>
                    </select>
                </li>
                <li data-input-trigger class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q6">Le voyage en Venise</label>
                    <select class="cs-select cs-skin-slide fs-anim-lower" id="q6" name="q6">
                        <option value="false" data-class="icon-circleW">Non</option>
                        <option value="true" data-class="icon-circleB">Oui</option>
                    </select>
                </li>
                <li data-input-trigger class="li_style">
                    <div>
                        <label class="fs-field-label fs-anim-upper" for="q7">Un entrainement individuel</label>
                    ...
                    <div style="margin-top: 50px">
                        <label class="fs-field-label fs-anim-upper" for="q8">Participation aux 3 categories de Beach Volley Marathon</label>
                ...
                <li class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q9">Votre nom</label>
                    <input class="fs-anim-lower" id="q9" name="q9" type="text" placeholder="Dean Moriarty"/>
                </li>
                <li class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q10" data-info="We won't send you spam, we promise...">Laissez votre mail</label>
                    <input class="fs-anim-lower" id="q10" name="q10" type="email" placeholder="dean@road.us"/>
                </li>
                <li class="li_style">
                    <label class="fs-field-label fs-anim-upper" for="q11">Laissez votre portable</label>
            ...
            <button id="but" class="fs-submit" type="button">Envoyez votre demande</a></button>
        </form><!-- /fs-form -->
